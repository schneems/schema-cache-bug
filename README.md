...
## Setup pg stat statements

To get the pg stats working locally, first add the extension from within a psql session: CREATE EXTENSION pg_stat_statements;
Then, add this in your postgresql.conf file. (/usr/local/var/postgresql/postgresql.conf).
